...
class ListWidget(QListWidget):
    ...
    def Ui_init(self):
        ...
        self.setStyleSheet("QListWidget{background-image:url('main.jpg');border:0px solid gray;color:rgba(0,0,0,0.6);}"
                           "QListWidget::Item{padding-top:0px; padding-bottom:4px;background:rgba(255,255,255,0)}"
                           "QListWidget::Item:hover{background:rgba(255,255,255,0.2); }"
                           "QListWidget::item:selected{background:rgba(255,255,255,0); color:rgba(0,0,0,0.2); }"
                           "QListWidget::item:selected:!active{border-width:0px; rgba(255,255,255,0.3); }"
                           )
